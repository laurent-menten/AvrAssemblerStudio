	...
	extends Instruction_Rd5Rr5
{
	...
	public SUB( Register rd, Register rr )
	{
		super( rd, rr );

		int opc = InstructionSet.SUB.getOpcodeMaskValue();
		opc = InstructionSet.SUB.insertOperand( OperandType.d, opc, rd.getOperandIndex() );
		opc = InstructionSet.SUB.insertOperand( OperandType.r, opc, rr.getOperandIndex() );
		setOpcode( opc );
	}

	public static SUB newInstance( Integer opcode, Integer opcode2 )
	{
		int d = InstructionSet.SUB.extractOperand( OperandType.d, opcode );
		int r = InstructionSet.SUB.extractOperand( OperandType.r, opcode );

		return new SUB( Register.lookup(d), Register.lookup(r) );
	}
