	...
	extends Instruction_Rd5
{
	...
	public COM( Register rd )
	{
		super( rd );

		int opc = InstructionSet.COM.getOpcodeMaskValue();
		opc = InstructionSet.COM.insertOperand( OperandType.d, opc, rd.getOperandIndex() );
		setOpcode( opc );
	}

	public static COM newInstance( Integer opcode, Integer opcode2 )
	{
		int d = InstructionSet.COM.extractOperand( OperandType.d, opcode );

		return new COM( Register.lookup( d ) );
	}
	...
	public void execute( Core core )
	{
		...
		Value r = rd.compute( (a) -> { return (byte)( -1 - a ); } );
