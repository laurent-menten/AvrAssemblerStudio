	...
	extends Instruction_Rd5Rr5
{
	...
	public CPC( Register rd, Register rr )
	{
		super( rd, rr );

		int opc = InstructionSet.CPC.getOpcodeMaskValue();
		opc = InstructionSet.CPC.insertOperand( OperandType.d, opc, rd.getOperandIndex() );
		opc = InstructionSet.CPC.insertOperand( OperandType.r, opc, rr.getOperandIndex() );
		setOpcode( opc );
	}

	public static CPC newInstance( Integer opcode, Integer opcode2 )
	{
		int d = InstructionSet.CPC.extractOperand( OperandType.d, opcode );
		int r = InstructionSet.CPC.extractOperand( OperandType.r, opcode );

		return new CPC( Register.lookup(d), Register.lookup(r) );
	}
