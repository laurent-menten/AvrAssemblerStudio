...
(
	...
	statusRegister = "--------",
	syntax = "NEG Rd",
	description = "Two's complement (negate)"
)
public class NEG
	extends Instruction_Rd5
{
	...
	public NEG( Register rd )
	{
		super( rd );

		int opc = InstructionSet.NEG.getOpcodeMaskValue();
		opc = InstructionSet.NEG.insertOperand( OperandType.d, opc, rd.getOperandIndex() );
		setOpcode( opc );
	}

	public static NEG newInstance( Integer opcode, Integer opcode2 )
	{
		int d = InstructionSet.NEG.extractOperand( OperandType.d, opcode );

		return new NEG( Register.lookup( d ) );
	}
	...
	public void execute( Core core )
	{
		...
		Value r = rd.compute( (a) -> { return (byte)( 0 - a ); } );

		sreg.c( r.bit7() | r.bit6() | r.bit5() | r.bit4() | r.bit3() | r.bit2() | r.bit1() | r.bit0() );
		sreg.h( r.bit7() );
