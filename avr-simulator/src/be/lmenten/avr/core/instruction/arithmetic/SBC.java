	...
	extends Instruction_Rd5Rr5
{
	...
	public SBC( Register rd, Register rr )
	{
		super( rd, rr );

		int opc = InstructionSet.SBC.getOpcodeMaskValue();
		opc = InstructionSet.SBC.insertOperand( OperandType.d, opc, rd.getOperandIndex() );
		opc = InstructionSet.SBC.insertOperand( OperandType.r, opc, rr.getOperandIndex() );
		setOpcode( opc );
	}

	public static SBC newInstance( Integer opcode, Integer opcode2 )
	{
		int d = InstructionSet.SBC.extractOperand( OperandType.d, opcode );
		int r = InstructionSet.SBC.extractOperand( OperandType.r, opcode );

		return new SBC( Register.lookup(d), Register.lookup(r) );
	}
