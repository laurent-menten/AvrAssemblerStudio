	...
	extends Instruction_Rd5
{
	...
	public DEC( Register rd )
	{
		super( rd );

		int opc = InstructionSet.DEC.getOpcodeMaskValue();
		opc = InstructionSet.DEC.insertOperand( OperandType.d, opc, rd.getOperandIndex() );
		setOpcode( opc );
	}

	public static DEC newInstance( Integer opcode, Integer opcode2 )
	{
		int d = InstructionSet.DEC.extractOperand( OperandType.d, opcode );

		return new DEC( Register.lookup( d ) );
	}
