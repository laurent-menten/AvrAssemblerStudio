	...
	extends Instruction_Rd5
{
	...
	public LAC( Register rd )
	{
		super( rd );

		int opc = InstructionSet.LAC.getOpcodeMaskValue();
		opc = InstructionSet.LAC.insertOperand( OperandType.d, opc, rd.getOperandIndex() );
		setOpcode( opc );
	}

	public static LAC newInstance( Integer opcode, Integer opcode2 )
	{
		int d = InstructionSet.LAC.extractOperand( OperandType.d, opcode );

		return new LAC( Register.lookup( d ) );
	}
	...
	public void execute( Core core )
	{
		...
		Value r = rd.compute( (a,b) -> { return (byte)(a & (-1 - b)); }, z );
