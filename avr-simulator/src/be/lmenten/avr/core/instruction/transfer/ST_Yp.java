...
(
	...
	statusRegister = "--------",
	syntax = "ST Y+, Rd",
	description = "Store indirect to data space using index Y post-incremented"
)
public class ST_Yp
	extends ST
{
	...
	public ST_Yp( RegisterIndexXYZ rd, Register rr )
	{
		super( rd, rr );
	}

	public static ST_Yp newInstance( Integer opcode, Integer opcode2 )
	{
		int r = InstructionSet.ST.extractOperand( OperandType.r, opcode );
		int d = InstructionSet.ST.extractOperand( OperandType.d, opcode );

		return new ST_Yp( RegisterIndexXYZ.lookup( d ), Register.lookup( r ) );
	}
