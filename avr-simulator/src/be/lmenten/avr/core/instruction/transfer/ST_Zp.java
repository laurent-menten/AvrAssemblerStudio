...
(
	...
	statusRegister = "--------",
	syntax = "ST Z+, Rd",
	description = "Store indirect to data space using index Z post-incremented"
)
public class ST_Zp
	extends ST
{
	...
	public ST_Zp( RegisterIndexXYZ rd, Register rr )
	{
		super( rd, rr );
	}

	public static ST_Zp newInstance( Integer opcode, Integer opcode2 )
	{
		int r = InstructionSet.ST.extractOperand( OperandType.r, opcode );
		int d = InstructionSet.ST.extractOperand( OperandType.d, opcode );

		return new ST_Zp( RegisterIndexXYZ.lookup( d ), Register.lookup( r ) );
	}
