...
public enum RegisterXYZ
	implements IRegisterIndex
{
	X( "RAMPX", CoreControlRegister.RAMX, Register.R26, Register.R27 ),
	...
	private RegisterXYZ( String extendedRegisterName, CoreControlRegister extendedRegister, Register lowerRegister, Register upperRegister )
	{
	...
	public static RegisterXYZ lookup( int r )
	{
		return values() [r];
	}
