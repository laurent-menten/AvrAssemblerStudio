...
//		"org.jetbrains.annotations",
	...
	private static final boolean debugMode
		= Boolean.parseBoolean(
			System.getProperty( "be.lmenten.debug", "true" )
	);
	...
	static class Proxy
	{
		public static void main( String[] args )
		{
			...
			Application.launch( AvrAssemblerStudio.class, args );
			...
			throws URISyntaxException, IOException
	{
		...
		if( ! fxFile.exists() )
		{
			...
			if( fxDirName == null )
			{
				error( "JavaFx PATH_TO_FX environment variable not found." );
			}
		}
	...
	private static final Logger LOG
		= Logger.getLogger( FxLauncher.class.getName() );
}
